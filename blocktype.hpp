 ...
 */
constexpr std::string_view blockTypeToString(BlockType type) noexcept {
    switch (type) {
 ...
 */
constexpr std::string_view blockStateToString(BlockState state) noexcept {
    switch (state) {
 ...
 */
constexpr std::string_view separatorTypeToString(SeparatorType type) noexcept {
    switch (type) {
