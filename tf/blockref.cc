...
BlockRef::BlockRef(BlockId blockId, Version version, Params local_params)
...
void BlockRef::set_local_params(Params params) {
...
Result<Params> BlockRef::resolve_params(const Block& block,
